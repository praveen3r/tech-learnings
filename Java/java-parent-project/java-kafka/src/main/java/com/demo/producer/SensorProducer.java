...
public class SensorProducer {
   ...
   public static void main(String[] args) throws Exception{
		 ...
		 * "localhost:9092,localhost:9093"); props.put("key.serializer",
		 ...
		 * 
		 * for (int i=0 ; i<10 ; i++) producer.send(new
		 * ProducerRecord<>(topicName,"SSP"+i,"500"+i));
		 * 
		 * for (int i=0 ; i<10 ; i++) producer.send(new
		 * ProducerRecord<>(topicName,"TSS","500"+i));
		 * 
		 * producer.close();
		 * 
