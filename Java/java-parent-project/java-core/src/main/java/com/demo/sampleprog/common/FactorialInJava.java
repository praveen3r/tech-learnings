...
/**
 * Simple Java program to find factorial of a number using
 * recursion and iteration.
 * Iteration will use for loop while recursion will call
 * method itself
 */
public class FactorialInJava {
    public static void main(String args[]) {
        //finding factorial of a number in Java using
        //recursion - Example
    ...
    /*
     * Java program example to find factorial of
    ...
    /*
     * Java program example to calculate factorial
